...
def arduino_map(value, range_in_min, range_in_max, range_out_min, range_out_max):
    return int((value - range_in_min) * (range_out_max - range_out_min) // (range_in_max - range_in_min) + range_out_min)
...
wet_arrow_soil_image = pygame.transform.rotate(pygame.image.load('arrow.png'), 90)
wet_arrow_air_image = pygame.transform.rotate(pygame.image.load('arrow.png'), 90)
wet_soil_image = pygame.image.load('wet_soil.png')
wet_air_image = pygame.image.load('wet_air.png')
temp_soil_image = pygame.image.load('temp_soil.png')
temp_air_image = pygame.image.load('temp_air.png')
